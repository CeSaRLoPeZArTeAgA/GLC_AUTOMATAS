...
\begin{titlepage}
    ...
    \voffset0cm
	  \begin{center}
        ...
        {\large \textbf{Gramatica Libre de Contexto}}
...
\section{Gramática libre de Contexto y Generacion de Numeros Aleatorios}
...
\section{Desarrollo de Codigos y Desarrollo de ejemplos paso a paso}

\subsection{Desarrollo de Codigos}

\noindent Se hace la implementacion de las clases, sugueridas en el documento principal. Se tendra tres clases el codigo, los cuales seran:

\begin{itemize}[label=-]
    \item Clase Aleatoria.
    \item Clase Regla.
    \item Clase Gramatica.
\end{itemize}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\noindent \textbf{Clase Aleatorio - Park-Miller:}
\begin{lstlisting}
class Aleatorio:
    ...
    def seleccionar(self, left):
        ...
        for r in reglas:
            ...
            if indice < acumulado:
                elegido = r
                break
        for r in reglas:  # actualizar cont
            if r is not elegido:
                r.cont += 1
...
\subsection{Desarrollo de ejemplos paso a paso}


\subsubsection{Desarrollo Gramatica 1}

\subsubsection{Desarrollo Gramatica 2}

\subsubsection{Desarrollo Gramatica 3}
